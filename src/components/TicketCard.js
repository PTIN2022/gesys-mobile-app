...
function TicketCard(props) {
  ...
  console.log("ARRIBOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO", props.asunto)
  return (
    <Card mode="elevated" style={{ marginHorizontal: 5, marginBottom: 5, backgroundColor: "#ffffffdd" }}>
      <Card.Content style={{}}>
        ...
        <View style={{ flexDirection: "row-reverse" }}>
          <Button mode="contained" style={{ marginLeft: 10 }} onPress={() => navigation.navigate('Chat', { id: props.title })}>Detalle</Button>
        </View>
      </Card.Content>
    </Card>
  )
