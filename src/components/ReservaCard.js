...
function TextReserva (props) {
  ...
  const hideDialog = () => setVisible(false);
    ...
    return(
      <Card mode="outlined" style={{marginHorizontal: 5, marginBottom: 5}}>
        <Card.Content style={{}}>
          <View style={{flexDirection: "row"}}>
            ...
            <View style={{flex: 4, paddingLeft: 20}}>
              ...
              <View style={{flexDirection: "row"}}> 
                ...
                { props.status=='Activa' && 
                  (<Text style={{backgroundColor: '#00e39b66', color: "black", borderRadius: 10, paddingHorizontal: 10}}> {props.status} </Text>)
                }
